...
export interface UseFieldReturn<Input extends UseFieldElement, Value> {
  /** The dirty state */
  dirty: boolean
  /** The error state */
  error: string | null
...
export const useField = <
  Input extends UseFieldElement = HTMLInputElement,
...
): UseFieldReturn<Input, Type> => {
  const inputRef = useRef<Input | null>(null)
  const initializedRef = useRef<Input | null>(null)
